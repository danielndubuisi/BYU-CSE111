def main():
    ...
    # Call the miles_per_gallon function and store the result as mpg.
    mpg = miles_per_gallon(first_reading, second_reading, fuel_amount)

    # Call the lp100k_from_mpg function to convert the miles per gallon to liters per 100 kilometers and store as lp100k.
